...
const USOPEN_TIERS = {
  ...
  "The Field — Pick 2": {
    ...
    golfers: [
      ...
      { name: "Ben James", odds: "+33000", note: "Amateur" },
      { name: "Andrew Putnam", odds: "+34000" },
      { name: "Nico Echavarria", odds: "+35000" },
      { name: "Preston Stout", odds: "+44000", note: "NCAA champ" },
      { name: "Caleb Surratt", odds: "+45000" },
      { name: "Alex Smalley", odds: "+50000" },
      { name: "Chris Kirk", odds: "+50000" },
      { name: "Michael Brennan", odds: "+50000" },
      { name: "Emiliano Grillo", odds: "+52500" },
      { name: "Lucas Herbert", odds: "+55000" },
      { name: "Matti Schmid", odds: "+55000" },
      { name: "Billy Horschel", odds: "+57500" },
      { name: "Niklas Norgaard", odds: "+60000" },
      { name: "Patrick Rodgers", odds: "+60000" },
      { name: "Peter Uihlein", odds: "+60000" },
      { name: "Neal Shipley", odds: "+67500", note: "Amateur" },
      { name: "Angel Hidalgo", odds: "+70000" },
      { name: "Alejandro Tosti", odds: "+80000" },
      { name: "Carl Yuan", odds: "+80000" },
      { name: "Taylor Montgomery", odds: "+80000" },
      { name: "Matthew Jordan", odds: "+85000" },
      { name: "Brandon Wu", odds: "+90000" },
      { name: "Dylan Wu", odds: "+90000" },
      { name: "Jayden Schaper", odds: "+90000" },
      { name: "Adrien Dumont de Chassart", odds: "+110000" },
      { name: "Chandler Phillips", odds: "+110000" },
      { name: "Jackson Suber", odds: "+110000" },
      { name: "Laurie Canter", odds: "+110000" },
      { name: "Nick Hardy", odds: "+110000" },
      { name: "Adrien Saddier", odds: "+120000" },
      { name: "Ben Silverman", odds: "+120000" },
      { name: "Harry Higgs", odds: "+120000" },
      { name: "William Mouw", odds: "+120000" },
      { name: "Cole Hammer", odds: "+140000" },
      { name: "James Nicholas", odds: "+140000" },
      { name: "Max McGreevy", odds: "+140000" },
      { name: "Ben Kohles", odds: "+150000" },
      { name: "J.B. Holmes", odds: "+150000" },
      { name: "Kevin Roy", odds: "+150000" },
      { name: "Ryuichi Oiwa", odds: "+150000" },
      { name: "T.K. Kim", odds: "+150000" },
      { name: "Padraig Harrington", odds: "+160000", note: "🇮🇪 3x major champ" },
      { name: "Jack Schoenberger", odds: "+175000" },
      { name: "Johnny Keefer", odds: "+175000" },
      { name: "Cooper Dossey", odds: "+200000" },
      { name: "Ethan Fang", odds: "+200000", note: "Amateur" },
      { name: "Hennie Du Plessis", odds: "+200000" },
      { name: "Jackson Van Paris", odds: "+200000" },
      { name: "Jimmy Stanger", odds: "+200000" },
      { name: "John Parry", odds: "+200000" },
      { name: "Kaito Onishi", odds: "+200000" },
      { name: "Manav Shah", odds: "+200000" },
      { name: "Miles Russell", odds: "+200000", note: "Amateur" },
      { name: "Nathan Kimsey", odds: "+200000" },
      { name: "Spencer Tibbits", odds: "+200000" },
      { name: "Taihei Sato", odds: "+200000" },
      { name: "Ugo Coussaud", odds: "+200000" },
      { name: "Zac Blair", odds: "+200000" },
      { name: "Filippo Celli", odds: "+250000" },
      { name: "Greyson Leach", odds: "+250000" },
      { name: "Jake Peacock", odds: "+250000" },
      { name: "Jake Sollon", odds: "+250000" },
      { name: "Marcelo Rozo", odds: "+250000" },
      { name: "Robbie Higgins", odds: "+250000" },
      { name: "Rocco Repetto Taylor", odds: "+250000" },
      { name: "Brandon Holtz", odds: "+300000", note: "Amateur" },
      { name: "Chase Kyes", odds: "+300000", note: "Amateur" },
      { name: "Graeme McDowell", odds: "+325000", note: "LIV — 2010 U.S. Open champ" },
      { name: "Bryan Lee", odds: "+400000", note: "Amateur" },
      { name: "Eric Lee", odds: "+400000", note: "Amateur" },
      { name: "Hamilton Coleman", odds: "+400000", note: "Amateur" },
      { name: "Jackson Herrington", odds: "+400000", note: "Amateur" },
      { name: "Jackson Ormond", odds: "+400000", note: "Amateur" },
      { name: "Mateo Pulcini", odds: "+400000", note: "Amateur" },
      { name: "Vaughn Harber", odds: "+400000", note: "Amateur" },
      { name: "Arni Sveinsson", odds: "+500000", note: "Amateur" },
      { name: "Giuseppe Puebla", odds: "+500000", note: "Amateur" },
      { name: "Logan Reilly", odds: "+500000", note: "Amateur" },
      { name: "Marek Fleming", odds: "+500000", note: "Amateur" },
      { name: "Matthew Robles", odds: "+500000", note: "Amateur" },
      { name: "Ryder Cowan", odds: "+500000", note: "Amateur" },
    ]
  },
};
